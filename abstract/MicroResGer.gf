...
--      NPAgreement = Number | Person | Gender | Case ; 
    ...
    smartNoun : Str -> Gender -> Noun = \sg,g -> case sg of {
     -- x + ("p" |"b" |"m" |"n" |"f" |"v" |"t" |"s" |"d" |"z" |"l" |"sch" |"ch" |"j" |"k" |"g" |"r" |"l") => mkNoun sg (sg +"s") sg sg (sg + "ä" + "e") (sg + "ä" + "en") (sg + "ä" + "e") g ; 
      -- x + ("n" | "en" | "e") => mkNoun sg (sg + "en") sg (sg+"en")(sg+"en") (sg+"en")(sg+"en")(sg+"en")(sg+"en")(sg+"en") g ; 
     -- x + ("s") => mkNoun sg (sg + "s") sg (sg +"s") sg sg (sg +"s") (sg +"s") (sg +"s") (sg +"s") g ;
...
oper
  ...
  mkAdjective : Str -> Adjective = \pos -> {
    ...
    Pred => table {cas => table {gennum => pos}}
...
{-
 smartAdjective : (strong, weak, mixed : Str) -> Adjective 
  = \plural, mnom, macc, mdat, fnom, nnom -> {
   s = table {
      pos + "er" => mkAdjective 
      pos + "e" => mkAdjective
      pos + "es" => mkAdjective
